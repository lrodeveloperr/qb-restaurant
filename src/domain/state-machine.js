...
const transitions = new Map([
  ...
  [DayStatus.READY_FOR_REVIEW, new Set([DayStatus.READY_FOR_REVIEW, DayStatus.POSTING, DayStatus.NEEDS_MAPPING, DayStatus.INVALID_SOURCE, DayStatus.POSSIBLE_DUPLICATE, DayStatus.PAUSED, DayStatus.ENTITLEMENT_BLOCKED])],
  [DayStatus.POSSIBLE_DUPLICATE, new Set([DayStatus.ALREADY_POSTED, DayStatus.READY_FOR_REVIEW])],
  [DayStatus.POSTING, new Set([DayStatus.POSTED, DayStatus.ALREADY_POSTED, DayStatus.OUTCOME_UNKNOWN, DayStatus.FAILED])],
  [DayStatus.OUTCOME_UNKNOWN, new Set([DayStatus.POSTED, DayStatus.READY_FOR_REVIEW, DayStatus.FAILED])],
  [DayStatus.FAILED, new Set([DayStatus.READY_FOR_REVIEW, DayStatus.POSTING, DayStatus.NEEDS_MAPPING, DayStatus.INVALID_SOURCE, DayStatus.PAUSED])],
  ...
  [DayStatus.CORRECTION_REQUIRED, new Set([DayStatus.CORRECTING, DayStatus.EXTERNAL_CHANGE])],
  [DayStatus.CORRECTING, new Set([DayStatus.CORRECTED, DayStatus.CORRECTION_PARTIAL, DayStatus.OUTCOME_UNKNOWN, DayStatus.EXTERNAL_CHANGE])],
  [DayStatus.CORRECTION_PARTIAL, new Set([DayStatus.CORRECTING, DayStatus.CORRECTED, DayStatus.EXTERNAL_CHANGE])],
  ...
  [DayStatus.PAUSED, new Set([DayStatus.READY_FOR_REVIEW, DayStatus.WAITING, DayStatus.PAUSED])],
  [DayStatus.ENTITLEMENT_BLOCKED, new Set([DayStatus.READY_FOR_REVIEW, DayStatus.POSTING, DayStatus.ENTITLEMENT_BLOCKED])],
]);
